...
//   ACRONYM_CONFIG_SHEET is defined in Shared.gs
//   escapeRegex() is defined in Shared.gs
//
...
function scanAcronyms() {
  ...
  if (!sheet) {
    ui.alert("Error: Could not find a sheet named \"" + TRAINING_ACCESS_SHEET_NAME + "\".");
    return;
  }
...
// escapeRegex() is now in Shared.gs
